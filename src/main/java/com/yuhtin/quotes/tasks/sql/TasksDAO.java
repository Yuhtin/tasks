package com.yuhtin.quotes.tasks.sql;

import com.yuhtin.quotes.tasks.model.User;
import com.yuhtin.quotes.tasks.sql.provider.DatabaseProvider;
import com.yuhtin.quotes.tasks.sql.provider.document.Document;
import com.yuhtin.quotes.tasks.sql.provider.document.parser.impl.TasksDocumentParser;
